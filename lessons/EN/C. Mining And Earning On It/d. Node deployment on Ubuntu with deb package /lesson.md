...
4. Edit and save the configuration file.
    The node configuration file is embedded into the package and unpacked to the folder `/usr/share/waves/conf/waves.conf` with symlink to `/etc/waves/waves.conf`
