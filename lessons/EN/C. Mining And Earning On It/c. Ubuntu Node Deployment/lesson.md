...
- [Ubuntu Node Deployment](#ubuntu-node-deployment)
  ...
  - [Deb Package Deployment](#deb-package-deployment)
    ...
    - [Node Configuration](#node-configuration-1)
      ...
      - [Deb Package Configuration File Setup](#deb-package-configuration-file-setup)
    - [Synchronization](#synchronization-1)
      ...
      - [Deb Package Blockchain Synchronization](#deb-package-blockchain-synchronization)
  - [Waves Package Deployment](#waves-package-deployment)
    ...
    - [Synchronization](#synchronization-2)
      - [Blockchain Synchronization Process Description](#blockchain-synchronization-process-description-2)
...
##### Deb Package Configuration File Setup #####
