...
Each new block of the example blockchain is generated each second.  
So every minute 60 blocks are generated.  
...
So every minute, when we have 60 blocks generated, we compete with other nodes with a 10% chance of the next block generation.  
